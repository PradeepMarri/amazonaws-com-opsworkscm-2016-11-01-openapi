# AWS OpsWorks CM MCP Server

This MCP (Model Content Protocol) server provides access to AWS OpsWorks CM API functionality through HTTP, HTTPS, and STDIO transport modes.
