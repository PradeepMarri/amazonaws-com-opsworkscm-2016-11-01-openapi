...
func RestoreserverHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.RestoreServerRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=OpsWorksCM_V2016_11_01.RestoreServer", cfg.BaseURL)
		...
		var result models.RestoreServerResponse
...
func CreateRestoreserverTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    RestoreserverHandler(cfg),
	}
}
