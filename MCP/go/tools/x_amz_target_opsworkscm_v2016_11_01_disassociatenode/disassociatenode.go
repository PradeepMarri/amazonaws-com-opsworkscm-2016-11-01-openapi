...
func DisassociatenodeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DisassociateNodeRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=OpsWorksCM_V2016_11_01.DisassociateNode", cfg.BaseURL)
		...
		var result models.DisassociateNodeResponse
...
func CreateDisassociatenodeTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DisassociatenodeHandler(cfg),
	}
}
